...
//      copy.querySelector(".vegan img").src = `media/icons/vegan.png`;
  ...
  NonPolluting()
		...
		function appendInshopping(){
		if(nameData.gsx$category.$t === "shopping")
		document.querySelector("article.shopping").appendChild(copy);
	}
	appendInshopping()// JavaScript Document
}